...
from .views import create_chatbot,get_chatbot_by_id,delete_chatbot_characteristic,delete_chatbot,get_user_chatbots,create_characteristic,update_chatbot_name,get_session_by_id,add_new_guest,add_new_session,add_new_message,get_session_messages
...
urlpatterns = [
    ...
    path('session_messages/<int:session_id>/',get_session_messages,name='get_session_messages')
]